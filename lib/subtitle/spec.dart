...
base class SubtitleSpec extends Spec<SubtitleSpec> {
  ...
  @override
  SubtitleSpec lerp(SubtitleSpec? other, double t) {
  ...
  static SubtitleSpec of(BuildContext context) {
    final mix = Mix.of(context);
    return mix.attributeOf<SubtitleSpecAttribute>()?.resolve(mix) ?? const SubtitleSpec();
  }
}

final class SubtitleSpecAttribute extends SpecAttribute<SubtitleSpec> {
  final TextOverflow? overflow;
  ...
  @override
  SpecAttribute<SubtitleSpec> merge(SubtitleSpecAttribute? other) {
    if (other == null) return this;
    return SubtitleSpecAttribute(
  ...
  @override
  SubtitleSpec resolve(MixData mix) {
    return SubtitleSpec(
      overflow: overflow,
...
class SubtitleSpecTween extends Tween<SubtitleSpec?> {
  SubtitleSpecTween({super.begin, super.end});

  @override
  SubtitleSpec lerp(double t) {
    if (begin == null && end == null) return const SubtitleSpec();
    if (begin == null) return end!;
    return begin!.lerp(end!, t);
  }
}

base class SubtitleSpecUtility<T extends Attribute> extends SpecUtility<T, SubtitleSpecAttribute> {
  ...
  SubtitleSpecUtility(super.builder);
  ...
  T only({
    ...
    return builder(SubtitleSpecAttribute(
      overflow: overflow,
      strutStyle: strutStyle,
      textAlign: textAlign,
      textScaler: textScaler,
